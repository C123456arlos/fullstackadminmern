...
import { AppBar, Button, IconButton, InputBase, Box, Typography, Menu, MenuItem, Toolbar } from '@mui/material'
                        ...
                        <FlexBetween>
                            <Button onClick={handleClick} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', textTransform: 'none', gap: '1rem' }}>
                                <Box component='img' alt='profile' src={profileImage} height={'32px'} width={'32px'}
                                    borderRadius={'50%'} sx={{ objectFit: 'cover' }}></Box>
                                <Box textAlign='left'>
                                ...
                                <ArrowDropDownOutlined
                                    sx={{ color: theme.palette.secondary[300], fontSize: '25px' }}></ArrowDropDownOutlined>
                            </Button>
